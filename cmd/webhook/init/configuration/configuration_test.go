...
func TestInit(t *testing.T) {
	...
	cfg = Init([]string{"--server-port", "8383", "--domain-filter", "x.test.com", "--domain-filter", "y.test.io"})
	assert.Equal(t, "testhost", cfg.ServerHost)
	assert.Equal(t, 8383, cfg.ServerPort)
	assert.Equal(t, []string{"x.test.com", "y.test.io"}, cfg.DomainFilter)
